// Requires DEIPO_TEST_DATABASE_URL pointing to a disposable migrated localhost DB.
...
try {
 ...
 code=build.status ?? 1;
 if(code===0)code=spawnSync(process.execPath,['node_modules/@playwright/test/cli.js','test','--config','playwright.checkout.config.ts'],{env,stdio:'inherit'}).status ?? 1;
