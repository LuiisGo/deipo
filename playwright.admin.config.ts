...
export default defineConfig({outputDir:'./test-results/admin',testDir:'./tests/admin-browser',workers:1,timeout:60000,use:{baseURL:'http://127.0.0.1:3002',channel:'chrome',screenshot:'only-on-failure',trace:'retain-on-failure'},webServer:[{command:`${node} tests/fixtures/supabase-http.mjs`,url:'http://127.0.0.1:54329/reset',env},{command:`${node} node_modules/next/dist/bin/next start --hostname 127.0.0.1 --port 3002`,url:'http://127.0.0.1:3002/admin/login',env}],reporter:'list'});
